...
// #define	USBTINY_USB_OK_LED		(A,5)

// Setting this to 1 will include the USB bus status API, allowing
// the MCU to determine if the connection is present.
#define USBTINY_USB_STATUS_API 1

// Optional defintion of a Vbus-sense pin. If defined, this will be used
// to check for a detach event and will reset the bus. This pin should
// have a 22kohm pulldown on it.
#define USBTINY_USB_VBUS_SENSE	(A, 4)
...
#define	USBTINY_DEVICE_ID		0x0002

// The version of the device as a 16-bit number: 256*major + minor.
#define	USBTINY_DEVICE_VERSION		0x010
...
#define	USBTINY_VENDOR_NAME		"Edward Holets"
#define	USBTINY_DEVICE_NAME		"Day-of-Week Clock"
#define	USBTINY_SERIAL			"DEV001"
...
#define	USBTINY_INTERFACE_SUBCLASS	0x00
#define	USBTINY_INTERFACE_PROTOCOL	0x00
...
#define	USBTINY_ENDPOINT_INTERVAL	0x00	// how often does the host poll us


#define USBTINY_HID_COUNTRY_CODE 0x21
#define USBTINY_HID_REPORT_DESCRIPTOR_LENGTH 0x41
